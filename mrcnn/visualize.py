...
def display_images(images, titles=None, cols=4, cmap=None, norm=None,
    ...
    font = FontProperties(fname='/mnt/sdf/clf8113/datasets/fonts/simsun.ttc')
...
def display_instances(image, boxes, masks, class_ids, class_names,
    ...
    if file_name:
        save_path = os.path.join(save_dir, file_name.replace('jpg', 'png'))
    N = boxes.shape[0]
    if not N:
        import skimage.io
        if file_name:
    ...
    for i in range(N):
        ...
        if not captions:
            ...
            caption = captions[i]
        ax.text(x1, y1 + 8, caption, fontproperties=font,
    ...
    for i in range(N):
        ...
        if captions is not None:
            ...
            ax.text(x1, y1, caption, size=11, verticalalignment='top',
                    color='w', backgroundcolor="none", fontproperties=font,
